...
def main():
    argument_spec = dict(
            ...
            allowas_in=dict(required=False, type='str', choices=ACCEPTED),
            allowas_in_max=dict(required=False, type='str'),
            as_override=dict(required=False, type='str', choices=ACCEPTED),
            default_originate=dict(required=False, choices=ACCEPTED),
            ...
            max_prefix_warning=dict(required=False, type='bool', choices=BOOLEANS),
            next_hop_self=dict(required=False, type='str', choices=ACCEPTED),
            next_hop_third_party=dict(required=False, type='str', choices=ACCEPTED),
