...
#- nxos_vpc_interface: portchannel=10 peer_link=true host=68.170.147.165
# config portchannel20 to be vpc20
#- nxos_vpc_interface: portchannel=20 vpc=20 host=68.170.147.165
# remove whatever VPC config is on portchannel if any exists (vpc xx or vpc peer-link)
- nxos_vpc_interface: portchannel=80 host=68.170.147.165 state=absent
'''
